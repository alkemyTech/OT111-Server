...
public class UserDetailsCustomService implements UserDetailsService {
    ...
    @Override
    @Transactional
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {//Busca el usuario a verificar
        ...
        return new User(//cumple la misma funcion que el userDetails
                foundUser.getEmail(),
